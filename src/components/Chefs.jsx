export default function Chefs() {
  const chefs = [
    { name: "Anaya Singh", role: "Head Chef", img: "/anayasingh.jpg" },
    { name: "Amrita Morya", role: "Senior Chef", img: "/amritamorya.png" },
    { name: "Rina Thomas", role: "Pastry Specialist", img: "/rinathomas.png" },
  ];
